...
export function Navigation() {
    ...
    const NAV_ITEMS = [
        ...
        { path: 'https://simulate.formatdisc.hr', label: t.nav.studio, external: true },
                                    ...
                                    <motion.div
                                        ...
                                        {item.external ? (
                                            <a
                                                ...
                                                className="block px-4 py-3 rounded-lg text-muted-foreground hover:text-foreground hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-colors"
                                            >
                                                {item.label}
                                            </a>
                                        ) : (
