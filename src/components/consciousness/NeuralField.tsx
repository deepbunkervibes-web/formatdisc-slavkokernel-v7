import * as React from 'react';import { useState, useMemo, useRef } from 'react';
import { Canvas, useFrame } from '@react-three/fiber';
import * as THREE from 'three';

const NeuralFieldComponent = ({ phase, confidence = 0.0 }: {phase: string;confidence?: number;}) => {
...
export const NeuralField = React.memo(NeuralFieldComponent);
