...
const QuantumStateIndicatorComponent = ({ state }: {state: string;}) => {
...
export const QuantumStateIndicator = React.memo(QuantumStateIndicatorComponent);
QuantumStateIndicator.displayName = 'QuantumStateIndicator';