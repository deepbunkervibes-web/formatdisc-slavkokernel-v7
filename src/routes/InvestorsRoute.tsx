        ...
        <div className="min-h-screen bg-slate-950 pt-16 uppercase font-mono">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                ...
                <motion.div
                    ...
                    className="bg-black border border-white/10 rounded-2xl p-8 mb-16 relative overflow-hidden group"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                    {[
                        ...
                        <motion.div
                            ...
                            className="bg-black/40 backdrop-blur-sm rounded-xl border border-white/5 p-8 hover:border-white/20 transition-colors"
                        >
                ...
                <motion.div
                    ...
                    className="text-center bg-white/5 rounded-2xl border border-white/5 p-12"
                >
