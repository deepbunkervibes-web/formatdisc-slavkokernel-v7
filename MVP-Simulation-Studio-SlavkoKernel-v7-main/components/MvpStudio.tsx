          ...
          <div className="max-w-7xl mx-auto px-4 py-8 space-y-6 w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <GlassCard className="min-h-[500px] p-6 overflow-auto">
                  ...
                  {activeTab === 'mvp' && <MvpPreview blueprint={mvpBlueprint} />}
                  {activeTab === 'deck' && pitchDeck ? <PitchDeckView deck={pitchDeck} /> : activeTab === 'deck' && <div className="text-slate-500 dark:text-secondaryText text-center pt-10">Generating pitch deck...</div>}
                </GlassCard>
              </div>
            </div>
